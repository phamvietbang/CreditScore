import time
import click
from calculate.wallet_credit_score_v3 import WalletsCreditScore
from config import ArangoDBConfig, get_logger

logger = get_logger('Multichain Wallet Scores V3')
...
def multichain_wallet_scores_v3(graph, statistic_path, k, h, n_cpu, cpu, wallet_batch_size, max_workers,
                                loop, sleep):
